...
public class ViewHolder {
     ...
     * @return
     */
    public ViewHolder setTextBackAndColor(int viewId, int backGroundResource, int color) {
        TextView tv = getView(viewId);
        if (color != -1)
            tv.setTextColor(color);
     ...
     * @return
     */
    public ViewHolder setRelativeDrawable(int viewId, Drawable drawable) {
        RelativeLayout iv = getView(viewId);
