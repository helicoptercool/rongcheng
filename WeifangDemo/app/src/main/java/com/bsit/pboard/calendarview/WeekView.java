...
public class WeekView extends View {
    ...
    private int nomalColor = Color.BLACK;//文字颜色
    private int weekColor = Color.parseColor("#FE4F20");//文字颜色
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.WeekView_week_color) {
                nomalColor = ta.getColor(R.styleable.WeekView_week_color, nomalColor);
    ...
    private void initPaint() {
        ...
        mWeekPaint.setColor(weekColor);
        mWeekPaint.setAntiAlias(true);
        mWeekPaint.setTextSize(weekSize);
    }
